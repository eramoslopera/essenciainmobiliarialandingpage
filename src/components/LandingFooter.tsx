...
const LandingFooter: React.FC = () => {
    ...
    return (
        <footer className="bg-[#222222] text-white pt-24 pb-12 px-6 lg:px-24 border-t border-gray-800">
            <div className="max-w-[1440px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 border-b border-gray-800 pb-16">
                    <div className="col-span-1">
                        <div className="mb-8">
                            <a href="https://essenciainmobiliaria.com/?noredirect=1" title="Volver a Essencia Inmobiliaria">
                    ...
                    <div className="md:text-right">
                        <h5 className="font-black text-[10px] uppercase tracking-[0.3em] mb-8 text-gray-400">{t('footer.contact')}</h5>
